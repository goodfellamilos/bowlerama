...
describe('calculateScores()', () => {
  ...
  it('should return [[10, "X", 13], [1, 2, 3]] for [[10, "X", 10], [1, 2, 3]]', () => {
    expect(calculateScores([[10, 'X', 10], [1, 2, 3]])).toEqual([[10, 'X', 13], [1, 2, 3]]);
  });

  it('should return [[10, "X", 20], [10, "X", 10]] for [[10, "X", 10], [10, "X", 10]]', () => {
    expect(calculateScores([[10, "X", 10], [10, "X", 10]])).toEqual([[10, "X", 20], [10, "X", 10]]);
  });

  it('should return [[5, 5, 11], [1, 2, 3]] for [[5, 5, 10], [1, 2, 3]]', () => {
    expect(calculateScores([[5, 5, 10], [1, 2, 3]])).toEqual([[5, 5, 11], [1, 2, 3]]);
  });
});
